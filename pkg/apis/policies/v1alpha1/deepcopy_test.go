...
var samplePolicy = TestPolicy{
	ObjectMeta: metav1.ObjectMeta{
		Name:      "foo",
		Namespace: "default",
	}}

var samplePolicySpec = TestPolicySpec{
	Severity:                        "high",
...
func TestTestPolicySpecDeepCopyInto(t *testing.T) {
	policySpec2 := TestPolicySpec{}
	samplePolicySpec.DeepCopyInto(&policySpec2)
	assert.True(t, reflect.DeepEqual(samplePolicySpec, policySpec2))
}

func TestTestPolicySpecDeepCopy(t *testing.T) {
	policySpec2 := samplePolicySpec.DeepCopy()
	assert.True(t, reflect.DeepEqual(samplePolicySpec, *policySpec2))
}

func TestTestPolicyListDeepCopy(t *testing.T) {
	items = append(items, samplePolicy)
	samplePolicyList := TestPolicyList{
		TypeMeta: typeMeta,
		ListMeta: listMeta,
		Items:    items,
	}
...
func TestTestPolicyListDeepCopyInto(t *testing.T) {
	items = append(items, samplePolicy)
	samplePolicyList := TestPolicyList{
		TypeMeta: typeMeta,
		ListMeta: listMeta,
	...
	samplePolicyList2 := TestPolicyList{}
	samplePolicyList.DeepCopyInto(&samplePolicyList2)
	assert.True(t, reflect.DeepEqual(samplePolicyList, samplePolicyList2))
}

func TestTestPolicyStatusDeepCopy(t *testing.T) {
	...
	samplePolicyStatus := TestPolicyStatus{
...
func TestTestPolicyStatusDeepCopyInto(t *testing.T) {
	var compliantDetail = map[string][]string{}
	var compliantDetails = map[string]map[string][]string{}
	details := []string{}
	...
	var samplePolicyStatus2 TestPolicyStatus
